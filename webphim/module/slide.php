...
<script language="Javascript">
        jssor_slider2_starter = function (containerId) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider2.$SetScaleWidth(Math.min(parentWidth, 1140px));
                else
...
<div class="slide" style="width:1140px;height:428px;margin-left:12px;">
                       <!-- Caption Style -->
    ...
    <div id="slider2_container" style="position: relative; width: 1140px;
        height: 428px;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0; top: 0px; width: 1140px; height: 420px; overflow: hidden;">
		<?php
			include("module/connectdatabase.php");
					$sql="SELECT * FROM `movies`  WHERE id_loaiphim=3 ORDER BY movies.id DESC LIMIT 0,4 ";
					$kq=mysqli_query($conn,$sql);
					while($row=mysqli_fetch_array($kq)){
		?>
            <div>
                <a u=image href="?view=detail_movie&id=<?=$row['id']?>" data-toggle="tooltip" data-placement="left" title="<?php echo $row['name'];echo $row['details'];?>" ><img src=<?=$row['poster']?> width="1140px"/></a>
				<div class="carousel-caption">
                     <h2 class="BC" style="font-family:abc;font-weight:none;font-style:italic;"><?=$row['name']?></h2>
                </div>
            </div>
		<?php
					}
        ...
        <style>
            ...
            */
            ...
            .jssorb01 .av { background-color: #F39B13; }
